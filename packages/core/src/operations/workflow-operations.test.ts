...
describe('gate decisions in the run transcript', () => {
  ...
  // Scoped to this group, not the file: only these cases redirect ARCHON_HOME, and
  // inside a container `getArchonHome()` would otherwise ignore the redirect and
  // look for the transcript under /.archon.
  honorArchonHomeEnv();
